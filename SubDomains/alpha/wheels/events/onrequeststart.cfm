<cffunction name="onRequestStart" returntype="void" access="public" output="false">
	...
	<cfif not isdefined("session.twitter") or isdefined("url.resettwitter")>
		<cfset session.twitter = structnew()>
		<cfset session.twitter.oAuthToken = "">
		<cfset session.twitter.oauthTokenSecret = "">
		<cfset session.twitter.accessToken = "">
		<cfset session.twitter.accessSecret = "">
		<cfset session.twitter.screen_name = "">
		<cfset session.twitter.user_id = "">
	</cfif>
